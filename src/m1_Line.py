...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.originalstartx = start.x
        self.originalstarty = start.y
        self.originalendx = end.x
        self.originalendy = end.y
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        point1 = Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y)
        point2 = Point(self.end.x + other_line.end.x, self.end.y + other_line.end.y)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start.x = self.originalstartx
        self.start.y = self.originalstarty
        self.end.x = self.originalendx
        self.end.y = self.originalendy
